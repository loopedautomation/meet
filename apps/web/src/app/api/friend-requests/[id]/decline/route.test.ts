...
useIsolatedTestDb("meet_test_284_decline")
...
function req(): Request {
  return new Request("http://x/api/friend-requests/x/decline", {
    method: "POST",
  })
}
...
describe("POST /api/friend-requests/[id]/decline", () => {
  ...
  it("discards the request when the recipient declines", async () => {
