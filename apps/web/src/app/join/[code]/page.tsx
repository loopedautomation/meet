      ...
      <section className="flex flex-1 flex-col items-center justify-center gap-4 pb-24 text-center">
        {!invite.ok ? (
          <>
            ...
            <p className="text-base-content/70">{reasonCopy[invite.reason]}</p>
          ...
          <>
            <h1 className="font-semibold text-2xl">You're already a member</h1>
          ...
          <>
            ...
            <p className="text-base-content/70">
              ...
              {invite.role === "admin" ? "n admin" : " member"}. Joining is your
              call — nothing happens until you accept.
            </p>
